...
export default function Description(){
    ...
    return (
        <div id="description" className=" cursor-auto flex flex-col px-5 xl:px-2 pt-10 lg:pb-48 w-screen relative justify-center items-start text-white xl:pb-36 2xl:pb-96 xl:pl-0 xl:h-full xl:w-full xl:max-h-screen xl:min-h-screen">
