...
export default function Recommendations (){
  ...
  return (
    <div id="Recommendations" className="w-full  h-full px-5 xl:px-2 flex flex-col justify-center gap-10 items-start ">
        <h1 className='text-xl 2xl:text-2xl font-semibold text-ecru'>{t("title")}</h1>
        <p className="text-md w-full xl:w-11/12 ">{t("intro")}</p>
