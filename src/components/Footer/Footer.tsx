...
export default function Footer(){
    ...
    return(
        <div id="Footer" className=" flex-col hidden  h-20 xl:pb-36  fixed xl:flex bottom-0 justify-start gap-3 items-center bg-transparent lg:pl-2">
            ...
            <a target="_blank" href="https://drive.google.com/drive/u/0/folders/1v8U2nPqymtBSypum5lRViZkPtzQXLwXw" className="w-full flex justify-start gap-1 items-end">
