...
export default function Description(){
    ...
    return (
        <div id="description" className=" flex flex-col px-2 w-screen relative justify-center items-start text-white xl:pb-36 2xl:pb-96 xl:pl-0 xl:h-full xl:w-full xl:max-h-screen xl:min-h-screen">
